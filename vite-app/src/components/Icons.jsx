...
export const TrophyIcon = ({ className = 'w-5 h-5' }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4a5 5 0 005 5h4a5 5 0 005-5V3M5 3h14M5 3H3m16 0h2m-6 18H9m3 0v-4" />
    </svg>
);
...
export const SportIcon = ({ sport }) => {
    ...
    return <span className="mr-2 text-xl inline-block">{icons[sport] || '⚽️'}</span>;
};
