...
import { dayOptions, getTeamShirtColor } from '../config/constants';
                            ...
                            <div key={team.id} className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/60 space-y-3">
                                <div className="flex items-center justify-between flex-wrap gap-3">
                                    <div className="flex items-center flex-wrap gap-3">
                                        ...
                                        <button onClick={() => onEditTeam(team)} className="text-slate-400 hover:text-blue-500 p-1 rounded-full hover:bg-blue-50 transition-colors" title="Editar Nombre, Logo y Playera">
                                            <EditIcon className="w-4 h-4" />
                                        </button>

                                        {/* Insignia con Icono 👕, Muestra de Color y Nombre Visible (Gildan) */}
                                        <span
                                            className="inline-flex items-center gap-1.5 text-xs font-black px-3 py-1 rounded-xl border shadow-sm cursor-pointer hover:scale-105 transition-transform"
                                            style={{
